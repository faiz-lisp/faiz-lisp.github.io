function initHtmlContent() {
  document.body.innerHTML = '<table align="center" height="416" style="background-color:#006400;">' +
          ...
          '</table>'+
					...
					'<br>'
					+'<div style="position:relative;top:0em;left:32em;height:10em;width:36em;">'
					+'<button id=up onClick=up() style="position:relative;top:0em;left:3em;height:2em;width:2em;">^</button>'
					+'<br>'+'<button id=lf onClick=lf() style="position:relative;top:0.5em;left:.5em;height:2em;width:2em;"><</button>'
					+'<button id=ct onClick=ct() style="position:relative;top:.8em;left:1em;height:2em;width:2em;"></button>'
					+'<button id=rt onClick=rt() style="position:relative;top:.5em;left:1.5em;height:2em;width:2em;">></button>'
					+'<br>'+'<button id=dn onClick=dn() style="position:relative;top:1.2em;left:3em;height:2em;width:2em;">v</button>'
					+'</div>'
					;
}
...
p_goods_array[32] = new GuaiWu(32, "终极魔王",32,[{name:"shengming",value:120000},{name:"gongjiMin",value:5000},{name:"gongjiMax",value:8000},{name:"fangyu",value:4800},{name:"sudu",value:45},{name:"jinbiMin",value:500},{name:"jinbiMax",value:1250},{name:"jingyanMin",value:500},{name:"jingyanMax",value:900}]);
  ...
  p_goods_array[601] = new NPC(601, 601, [
    {
      speaking:['精灵：你好！勇士！我是这里的精灵！','你好，精灵！','精灵：你就是被派遣到mota里搭救公主的勇士？',
        '精灵：我们的公主被困在mota的顶层，那里有个可怕的大魔王看守！',
